...
namespace RandomizerTracker
{
    static class UnTranslator
    {
        ...
        static UnTranslator() // Generate dictionary from embedded file RoomDict
        {
            ...
            {
                string[] rooms = roomPair.Split(':'); //split string into badName and goodName
                try
                {
        ...
        public static string TranslateTransitionName(string goodName) // For use with Randomizer3.0 transition names
        {
            string[] transitionArray = goodName.Split('[', ']');
